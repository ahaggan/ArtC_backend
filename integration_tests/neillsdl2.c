...
void Neill_SDL_Init(SDL_Simplewin *sw)
{
   ...
   // Set screen to black
   Neill_SDL_SetDrawColour(sw, 0, 0, 0, 0);
...
void Neill_SDL_SetDrawColour(SDL_Simplewin *sw, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
...
void Neill_SDL_RenderFillCircle(SDL_Renderer *rend, int cx, int cy, int r, int a)
{
...
// http://content.gpwiki.org/index.php/SDL:Tutorials:Drawing_and_Filling_Circles
void Neill_SDL_RenderDrawCircle(SDL_Renderer *rend, int cx, int cy, int r, int a)
{
