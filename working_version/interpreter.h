/*
Module takes an interpreter array, contructed in the parser and assigns values from it to the draw fractal structure. This is used to draw the fractal image on the canvas
*/
