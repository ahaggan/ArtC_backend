/*
Module contains general SDL helper functions used to display menus and images in SDL
*/ 
...
//Function quits the program and is called if there is an error within the SDL functions
