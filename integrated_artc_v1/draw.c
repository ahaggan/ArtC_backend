...
void clear_area(SDL_Win *interface->window, Area area)
{
    SDL_SetRenderDrawColor(interface->window->renderer, area.colour.r, area.colour.g, area.colour.b, 255);
    SDL_RenderFillRect(interface->window->renderer, &area.rect);
